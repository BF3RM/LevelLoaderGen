#!/usr/bin/env python3
"""Translate MapEditor's PartitionSerializer JSON into the EBX JSON Rime compiles.

Used by ebx_json.py to bake per-instance EBX overrides: MapEditor stores each edited instance's
cloned blueprint as a serialized partition in the save file, and this turns it into something
add_json_partition can compile.
...
See MapEditor's docs/bake-pipeline.md §7 for the full field-shape table.
"""
import json
